...
class Game:
    ...
    def _init(self):
        ...
        SolidSprite(self.camera_group, self.solid_sprites, file_name='solid_textures/solid_tile.png', x=100, y=200)
        SolidSprite(self.camera_group, self.solid_sprites, file_name='solid_textures/solid_tile.png', x=300, y=200)
        # SolidSprite(self.camera_group, self.solid_sprites, file_name='solid_textures/solid_tile.png', x=500, y=450)
        # SolidSprite(self.camera_group, self.solid_sprites, file_name='solid_textures/solid_tile.png', x=100, y=500)
        self._running = True
        pygame.init()
